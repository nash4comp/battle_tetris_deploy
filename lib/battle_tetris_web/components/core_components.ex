defmodule BattleTetrisWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BattleTetrisWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BattleTetrisWeb.Gettext, "errors", msg, opts)
    end
  end
