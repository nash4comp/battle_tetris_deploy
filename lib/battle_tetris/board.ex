defmodule BattleTetris.Board do
  alias BattleTetris.{Block, Coordinates}
  alias BattleTetris.Board.Row
  ...
  def block_type_at(board, {x, y}) do
    block =
    BattleTetris.Board.static_block_at(board, {x, y}) ||
        (BattleTetris.Board.falling_block_at?(board, {x, y}) && board.falling_block)
